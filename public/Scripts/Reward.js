...
var rewardList = ['200 units metal + 100 units crystal', '+1 rocket launcher', '2,000 metal + 500 crystals', '1500 deuterium', ' 2 espionage probes', '2 heavy fighters, 5 small cargoes', '1 large cargo, 5 small cargos, 10000 of each resorces', '20000 metal, 15000 crystal, 10000 deuterium', '2 recycler', '10 light fighters, 3 heavy fighters, 1 Battleship'];
var task1List = ['Upgrade metal mine to level 4','Upgrade the deuterium synthesizer to level 2','Upgrade your metal mine onto level 10','Build a research laboratory with level 1','Research the combustion drive on level 3','Research the impulse drive on level 1','Research the laser tecnology on level 3','Upgrade your metal mine onto level 17','Research the combustion drive on level 6','Research the ion technology on level 2'];
var task2List = ['Upgrade crystal mine to level 2','Build a shipyard of level 1','Upgrade your crystal mine onto level 7','Research the combustion drive on level 2','Research the espionage technology on level 2','Research the armour technology on level 1','Research the impulse drive on level 3','Upgrade your crystal mine onto level 15','Research the shielding technology on level 2','Research the impulse drive on level 4'];
