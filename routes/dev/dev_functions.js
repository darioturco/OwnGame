...
var universeParams = {name: 'DevUniverse', speed: 1, speedFleet: 100};

var dev = {
  setUniverseParams: function(name, speed, speedFleet){
    universeParams.name       = name       ?? universeParams.name;
    universeParams.speed      = speed      ?? universeParams.speed;
    universeParams.speedFleet = speedFleet ?? universeParams.speedFleet;
  },
  ...
  setPlanetDataDev: function(coor){
    ...
    base.getDb().collection("jugadores").updateOne(
  ...
  addResources: function(coor, resources){
    base.addPlanetData(coor, resources, {}, false);
  },

  executeDevCode: function(){
    dev.addResources({gal: 1, sys: 14, pos: 6}, {meta: 100, crystal: 1000, deuterium: 1000});

    // const debrisCoor   = {gal: 1, sys: 14, pos: 10};
    // const recyclerCoor = {gal: 1, sys: 14, pos: 6};
    // base.saveDebris(debrisCoor, {active: true, metal: 500000, crystal: 300000}, false);
    // base.addPlanetData(recyclerCoor, {}, {recycler: 10}, false);
  ...
  setupPlayer: function(){
    ...
    uni.createUniverse(universeParams.name, 5, {name: "", inicio: 0, maxGalaxies: 9, donutGalaxy: true, donutSystem: true, speed: universeParams.speed, speedFleet: universeParams.speedFleet, fleetDebris: 30, defenceDebris: 0, maxMoon: 20, rapidFire: true});
    uni.addNewPlayer("dturco", 1, 'human');
